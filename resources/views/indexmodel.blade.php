...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link active" href="/datainsert">insert <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="summaary">summary</a>
